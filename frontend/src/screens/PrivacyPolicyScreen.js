...
import { APP_CONTACT_URL, APP_PRIVACY_URL, EMAIL, PROD_BASE_URL } from '../data/constants'
...
const PrivacyPolicyScreen = (props) => {
    ...
    const metas = [
        {idKey: 'property', idValue: 'og:title', updateKey: 'content', updateValue: 'Privacy policy | Famous-Quotes.uk'},
        {idKey: 'property', idValue: 'og:description', updateKey: 'content', updateValue: 'Privacy policy for Famous-Quotes.uk.'},
        {idKey: 'property', idValue: 'og:image', updateKey: 'content', updateValue: `${PROD_BASE_URL}/share-icon.png`},
        {idKey: 'property', idValue: 'og:url', updateKey: 'content', updateValue: `${PROD_BASE_URL}${APP_PRIVACY_URL}`},
    ...
    const links = [
        {idKey: 'rel', idValue: 'canonical', updateKey: 'href', updateValue: `${PROD_BASE_URL}${APP_PRIVACY_URL}`},
    ]

    return (
        <GenericScreen metas={metas} links={links} title={'Privacy policy | Famous-Quotes.uk'}>
            <div className='container text-justify my-5'>
                ...
                <ul>
                    ...
                    <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Famous Quotes.</p></li>
                    ...
                    <li><p><strong>Website</strong> refers to Famous Quotes, accessible from <a href={PROD_BASE_URL} rel="external nofollow noopener noreferrer" target="_blank">{PROD_BASE_URL}</a></p></li>
                ...
                <ul>
                    <li><p>By email: {EMAIL}</p></li>
                    <li><p>By visiting this page on our website: <a href={APP_CONTACT_URL} rel="external nofollow noopener noreferrer" target="_blank">{APP_CONTACT_URL}</a></p></li>
                </ul>
            </div>
        </GenericScreen>
    )
